...
All the code is in R and the book written in RMarkdown using the bokdown package. This version, incorporates code into the text but there is also a [code-free version]()  Some chapters highlight packages or functions which I may have used for the first time
