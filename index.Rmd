...
The basis is the weekly [blog posts](http://mytinyshinys.com/categories/eplweekly/) I have produced over the course of the 2017/18 English Premier League season. However, it has been significantly expanded with end-of season follow-ups on the analyses conducted each week 

All the code is in R and the book written in RMarkdown using the bokdown package. This version, incorporates code into the text but there is also a [code-free version](https://mytinyshinys.com/annual)  Some chapters highlight packages or functions which I may have used for the first time
...
Charts are generally zoomable/pannable and often more detailed information can be found by hovering markers
