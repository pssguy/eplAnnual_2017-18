...
Only one point from the top four this week-end means Chelsea still have chance to catch Liverpool and Spurs. Stoke first condemned to the drop


```{r topGame_37}

embed_youtube("ih7vZ9RgKKQ", width = 420, height = 315, frameborder = 0,
...
```{r}  
shortcode("tweet", "992894955650670592") 
```
