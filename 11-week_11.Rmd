...
Azipcuelta hooked up with Morata .. more time finishing with a, career-high, .. assists
with only one other defender, Aaron Cresswell topping him

de Bruyne helped David Silva score in consecutive games during December

####  Comebacks {-}

Here is the reverse of the chart above, providing end results when the team has a two goal advantage. Note how often Liverpool have spurned goo positions over the past few seasons
