...
A home shellacking by the putative champions leaves Arsenal 10 points off a top 4 spot
...
Arsenal ended the season .. points behind Man City (? worst ever) and .. points behind 5th laced.

The order in the mini 6 league was little different from the full standings
...
With Rojo, Blind and Shaw all failing to pass muster, Young, who will be 33 by the time next seasons starts, made the left back position his own and was on the pitch comfortably more than the previous two campaigns combined

---

#### Top Combos {-}

With his 12th assist of the season, Pogba finally pulled one out for Lukaku - somewhat surprising as the striker has scored 25% .. of the team's goals
...
An interesting quirk is that this is the first year he has laid on any for David Silva but ..  He notched  just one, for Oscar, whilst at Chelsea
