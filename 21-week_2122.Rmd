...
A bit of a mixed bag. Arsenal's are expensive, have performed but did not contribute an end-product for the club this year. Palace's underwhelmed but were mainly cover or bought for the future and they avoided relegation anyway. Newcastle's loans were very succesful but WBA;s were not. Moura gives the impression of another expensive squad player at Spurs
...
each %>% 
  ...
  add_markers(hoverinfo="text", color=~venue, colors=c("orange","blue"),
              text=~paste0(TIME," v ",TEAMNAME)) %>% 
  layout(margin=list(l=120),autosize = F, height = 500,
...
The earliest Manchester City allowed a goal at home was the 24th minute.(is this prem record need to code) Leicester's goal was only an equalizer and they were then hit by a 4 goal onslaught from Aguero, one of only two such hauls all season (Salah v Watford)
