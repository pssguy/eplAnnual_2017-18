...
However, Man City's goal difference .. which is the highest in Premier League history also exceeds many team's Goals Scored
...
As you can see their year ending goal difference of .. exceeds virtually every teams goals for. This season, only Liverpool with .. better that (and .. is best for second team?)

---

## Goal Scoring by Team {-}

Most teams score more goals in the second half of games as legs tire; teams press for a crucial goal; and extra minutes are added
...
Palace did, of course, improve and ended with .. and .. teams below them
Still didnt match Harry Kane ??
