...
??? With ony 2 goals Brighton and Stoke do feature towards the bottom end in EPL history

---

??? Newcastle went one better when they won 4 in a row later in the season, not done by a promoted team since ?

Neither Brighton nor Huddersfield managed more than two game winning sequences 

---

#### Player on the decline {-}

Things dod not improve for Jason Puncheon
...
As for Manchester United, the torrid start was not maintained ?? wait until season end
